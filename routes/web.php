...
// ============================================
// TEMPORARY: Google Drive Setup Routes
// Visit /auth/google once to authenticate
// Then you can remove/comment these routes
// ============================================
...
Route::get('/auth/google/callback', function (\Illuminate\Http\Request $request) {
	$service = new \App\Services\GoogleDriveService();
	$service->authenticate($request->code);
	return '<h1>✅ Google Drive Authenticated Successfully!</h1>
            <p>Token saved to storage/app/google-token.json</p>
            <p>You can now remove the setup routes from routes/web.php</p>
